...
@interface QDRWebViewController ()<WKNavigationDelegate, WKUIDelegate,WXApiDelegate, UINavigationControllerDelegate, deleteUrlDelegate, WeiboSDKDelegate, UIScrollViewDelegate>
