...
#define LOCAL_READ_UUID (NSString *)[SSKeychain passwordForService:@"com.dawenming.QingDianDemo" account:@"com.dawenming.QingDianDemo"]
...
#define BUNDLEID @"com.dawenming.QingDianDemo"                          // 项目包名
